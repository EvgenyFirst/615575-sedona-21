...
var removeSedonaNoJs = document.querySelector('.sedona');
removeSedonaNoJs.classList.remove('sedona__no-js');
var removeSedonaWrapperNoJs = document.querySelector('.sedona__wrapper');
removeSedonaWrapperNoJs.classList.remove('sedona__wrapper-no-js');
var removeReviewsNoJs = document.querySelector('.reviews');
removeReviewsNoJs.classList.remove('reviews-no-js');
